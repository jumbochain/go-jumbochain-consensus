...
type SyncCommitteeValidators struct {
	...
	Validators          []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,rep,packed,name=validators,proto3" json:"validators,omitempty" cast-type:"github.com/jumbochain/go-jumbochain-consensus/consensus-types/primitives.ValidatorIndex"`
...
var file_proto_eth_v2_sync_committee_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
func file_proto_eth_v2_sync_committee_proto_init() {
	...
	file_proto_eth_v2_sync_committee_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
