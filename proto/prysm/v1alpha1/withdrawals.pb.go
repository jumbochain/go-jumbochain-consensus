...
type BLSToExecutionChange struct {
	...
	ValidatorIndex     github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/jumbochain/go-jumbochain-consensus/consensus-types/primitives.ValidatorIndex"`
