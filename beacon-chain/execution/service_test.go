...
import (
	...
	dbutil "github.com/jumbochain/go-jumbochain-consensus/beacon-chain/db/testing"
	mockExecution "github.com/jumbochain/go-jumbochain-consensus/beacon-chain/execution/testing"
...
func (g *goodLogger) SubscribeFilterLogs(ctx context.Context, q jumbochain.FilterQuery, ch chan<- gethTypes.Log) (jumbochain.Subscription, error) {
	if g.backend == nil {
...
func (g *goodLogger) FilterLogs(ctx context.Context, q jumbochain.FilterQuery) ([]gethTypes.Log, error) {
	if g.backend == nil {
